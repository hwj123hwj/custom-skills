...
`;
  ...
  // Note: SEO metadata (JSON-LD, og tags, analytics) is handled by Astro
  // layouts (BaseLayout.astro / AppLayout.astro). The old index.html injection
  // has been removed since the migration to Astro SSG.
}
