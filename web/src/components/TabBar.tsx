...
interface TabBarProps {
  activeTab: 'skills' | 'decks' | 'prompts';
  skillCount: number;
  deckCount: number;
  promptCount: number;
  onTabChange: (tab: 'skills' | 'decks' | 'prompts') => void;
}

export function TabBar({ activeTab, skillCount, deckCount, promptCount, onTabChange }: TabBarProps) {
