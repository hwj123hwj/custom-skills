...
# ///
"""
导入一批更适合 wiki 编译线的 docs 来源知识种子。
目标是为同主题 concept / entity 增加更多 mentions，而不是只服务 deck showcase。
"""
...
DEFAULT_DOCS = [
    "docs/agent-infra/overview.md",
    "docs/agent-infra/knowledge-compile-layer.md",
    "docs/agent-infra/knowledge-to-deck-agent-spec.md",
    "docs/agent-stories/intel-agent.md",
    "docs/showcase/knowledge-to-deck-pipeline-notes.md",
]


def main():
    parser = argparse.ArgumentParser(description="导入更适合 wiki 编译线的 docs 知识种子")
