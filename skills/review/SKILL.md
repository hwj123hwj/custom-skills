...
If the project uses an issue tracker, fetch the originating issue/PRD for spec review.
...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, etc.) — if the project uses an issue tracker, fetch the originating issue/PRD for spec review.
...
>>>>>>> /tmp/tmp.8ZJnUwnMqR/skills/in-progress/review/SKILL.md
